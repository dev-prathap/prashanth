...
import Prathap from "../../../public/img/PRATHAP.jpg";
            ...
            <div className="text-center   text-gray-400">
              ...
              <ul className="flex justify-center mt-4 space-x-4">
                ...
                <li>
                  <a
                    href="#"
                    className="text-[#00acee] hover:text-gray-900  hover:text-white"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                ...
                <li>
                  <a
                    href="#"
                    className="text-gray-900 hover:text-gray-900  hover:text-white  text-gray-300"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
                ...
                <li>
                  <a
                    href="#"
                    className="text-[#ea4c89] hover:text-gray-900  hover:text-white"
                  >
                    <svg
                      className="w-6 h-6"
                      fill="currentColor"
